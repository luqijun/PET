...
image_points_num_filename = './data/UCF-QNRF_ECCV18/processed/min_edge_2048_split/Test/image_points_num.npy'

# model
model = "pet_dialated_full_split_dec"
backbone = "vgg16_bn"
position_embedding = "sine"  # 'sine', 'learned', 'fourier'
resume = "outputs/UCF_QNRF_General/pet_dialated_full_split_dec/pet_model_ntimes/checkpoint.pth"
...
# dataset
dataset_file = "UCF_QNRF_General"
data_path = "./data/UCF-QNRF_ECCV18/processed/min_edge_2048_split"
...
seg_level_split_th = 0.2  # 0.4-mae:109   0.3-mae:101.37
