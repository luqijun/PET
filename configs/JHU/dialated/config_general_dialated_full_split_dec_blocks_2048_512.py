...
image_points_num_filename = './data/JHU/processed/min_edge_2048_split_512/test/image_points_num.npy'

# model
model = "pet_dialated_full_split_dec"
backbone = "vgg16_bn"
position_embedding = "sine"  # 'sine', 'learned', 'fourier'
# resume = "outputs/JHU_General/pet_dialated_full_split_dec/pet_model_ntimes/checkpoint.pth"
...
data_path = "./data/JHU/processed/min_edge_2048_split_512"
