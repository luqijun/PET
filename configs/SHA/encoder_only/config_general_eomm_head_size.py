...
# criterion
criterion="criterion_mm_head_size"
...
point_loss_coef=5.0
eos_coef=0.5
weight_dict = {'loss_ce': ce_loss_coef, 'loss_points': point_loss_coef, 'loss_head_sizes': 5.0}
losses=['labels', 'points', 'head_sizes']
