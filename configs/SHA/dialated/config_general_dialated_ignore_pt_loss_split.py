...
deterministic = True
device = "cuda"
sub_save_dir = "ignore_pt_loss_split"
...
resume = "outputs/SHA_General/pet_dialated/ignore_pt_loss_split/pet_model_ntimes/checkpoint.pth"
dec_layers = 2
hidden_dim = 256
dim_feedforward = 512
nheads = 8
...
# criterion
criterion = "criterion_ignore_pt_loss_split"
