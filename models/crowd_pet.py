...
from .transformer.anchor_detr.crowd_win_transformer import *
...
class CrowdPET(nn.Module):
    ...
    def pet_forward(self, samples, features, pos, **kwargs):
        ...
        posemb_row = self.adapt_pos1d(self.pos2posemb1d(pos_row))
        posemb_col = self.adapt_pos1d(self.pos2posemb1d(pos_col))
        posemb_2d = None

        encode_src = self.context_encoder(src, src_pos_embed, mask, posemb_row, posemb_col, posemb_2d)
