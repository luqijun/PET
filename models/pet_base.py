...
class PET_Base(nn.Module, ABC):
    ...
    def __init__(self, backbone, num_classes, args=None):
        ...
        build_encoder, build_decoder = self.get_build_enc_dec_func()
        ...
        # quadtree splitter
        context_w = self.enc_win_size_list[-1][0]
        context_h = self.enc_win_size_list[-1][1]
