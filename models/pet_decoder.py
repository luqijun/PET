...
class PETDecoder(nn.Module):
    ...
    def __init__(self, backbone, num_classes, quadtree_layer='sparse', args=None, transformer=None, **kwargs):
        super().__init__()
    ...
    def forward(self, samples, features, context_info, **kwargs):
        ...
        # pqs = (query_embed, points_queries, query_feats, v_idx, depth_embed)
    ...
    def get_point_query(self, samples, features, **kwargs):
        ...
        query_embed, points_queries, query_feats, v_idx, depth_embed = self.points_queris_embed(samples,
                                                                                                self.pq_stride,
                                                                                                src,
                                                                                                **kwargs)
